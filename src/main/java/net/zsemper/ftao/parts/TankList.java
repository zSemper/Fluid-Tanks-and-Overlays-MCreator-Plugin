...
public class TankList extends JSimpleEntriesList<TankListEntry, FluidTanks.TankListEntry> {
    public TankList(MCreator mcreator, IHelpContext gui) {
        ...
        this.add.setText(L10N.t("elementGui.fluidTanks.tankListAdd"));
        this.setBorder(BorderFactory.createTitledBorder(BorderFactory.createLineBorder(Theme.current().getForegroundColor(), 1), L10N.t("elementGui.fluidTanks.tankListEntries"), 0, 0, this.getFont().deriveFont(12.0F), Theme.current().getForegroundColor()));
    }
